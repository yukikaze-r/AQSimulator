namespace AQSimulator {
	partial class Form1 {
		...
		private void InitializeComponent() {
			...
			this.facility2x2Button = new System.Windows.Forms.RadioButton();
			this.aqButton = new System.Windows.Forms.RadioButton();
			this.facility3x3Button = new System.Windows.Forms.RadioButton();
			this.facility4x4Button = new System.Windows.Forms.RadioButton();
			this.facility5x5Button = new System.Windows.Forms.RadioButton();
			...
			this.facility2x2Button.TabStop = true;
			this.facility2x2Button.Text = "施設2x2";
			this.facility2x2Button.UseVisualStyleBackColor = true;
			// 
			// aqButton
			// 
			this.aqButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.aqButton.Appearance = System.Windows.Forms.Appearance.Button;
			this.aqButton.AutoSize = true;
			this.aqButton.Location = new System.Drawing.Point(869, 803);
			this.aqButton.Name = "aqButton";
			this.aqButton.Size = new System.Drawing.Size(31, 22);
			this.aqButton.TabIndex = 2;
			this.aqButton.TabStop = true;
			this.aqButton.Text = "AQ";
			this.aqButton.UseVisualStyleBackColor = true;
			// 
			// facility3x3Button
			// 
			...
			this.facility3x3Button.TabStop = true;
			this.facility3x3Button.Text = "施設3x3";
			this.facility3x3Button.UseVisualStyleBackColor = true;
			// 
			// facility4x4Button
			// 
			...
			this.facility4x4Button.TabStop = true;
			this.facility4x4Button.Text = "施設4x4";
			this.facility4x4Button.UseVisualStyleBackColor = true;
			// 
			// facility5x5Button
			// 
			...
			this.facility5x5Button.TabStop = true;
			this.facility5x5Button.Text = "施設5x5";
			this.facility5x5Button.UseVisualStyleBackColor = true;
			// 
			// stepButton
			// 
			...
			this.stepButton.Location = new System.Drawing.Point(907, 803);
			...
			this.Controls.Add(this.facility3x3Button);
			this.Controls.Add(this.aqButton);
			this.Controls.Add(this.facility2x2Button);
		...
		private System.Windows.Forms.RadioButton facility2x2Button;
		private System.Windows.Forms.RadioButton aqButton;
		private System.Windows.Forms.RadioButton facility3x3Button;
		private System.Windows.Forms.RadioButton facility4x4Button;
		private System.Windows.Forms.RadioButton facility5x5Button;
